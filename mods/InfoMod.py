...
class InfoMod:
    rank = 0
    help_dict = {'py_info': 'basic bot info', 'py_owner': 'Who owns this bot? (hint: Ako)', 'py_git': 'github link'}
    owner = "<@132694825454665728>"
    version = "1.0"
    api = "discord.py " + str(discord.__version__)
    git = 'https://github.com/secknv/pymod/tree/00Unit'
    ...
    async def py_git(self):
        await self.client.send_message(self.message.channel, InfoMod.git)
